...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Analyzr - Real-time Analytics for Modern Applications",
    description: "Privacy-focused website analytics and event tracking tool for developers. Monitor user journeys, capture custom events, and get real-time insights.",
    siteName: "Analyzr",
    images: [
      {
        url: "/og.png",
  ...
  twitter: {
    ...
    title: "Analyzr - Real-time Analytics for Modern Applications", 
    description: "Privacy-focused website analytics and event tracking tool for developers",
    creator: "@arjuncodess",
    images: ["/og.png"]
  },
  icons: {
